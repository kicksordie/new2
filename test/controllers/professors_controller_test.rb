...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { department: @professor.department, link: @professor.link, name: @professor.name, title: @professor.title }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { department: @professor.department, link: @professor.link, name: @professor.name, title: @professor.title }
    assert_redirected_to professor_path(assigns(:professor))
  end
